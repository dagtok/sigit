...
var ArticuloService = (function () {
    function ArticuloService(http) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].production) {
            this.API_URL = 'http://' + __WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].api_url + ':8000/';
        }
        else if (__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].production === false) {
            this.API_URL = 'http://' + __WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].dev_api_url + ':8000/';
        }
    }
    ArticuloService.prototype.buscarArticulo = function (_parametro_de_busqueda) {
        var parametros = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpParams */]().set('buscar', _parametro_de_busqueda);
        return this.http.get(this.API_URL + 'api/articulos', { params: parametros });
    };
...
var AuthenticationService = (function () {
    function AuthenticationService(http) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].production) {
            this.API_URL = 'http://' + __WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].api_url + ':8000/';
        }
        else if (__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].production === false) {
            this.API_URL = 'http://' + __WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].dev_api_url + ':8000/';
        }
    }
...
var CategoriaService = (function () {
    ...
    CategoriaService.prototype.buscarCategoria = function (_parametro_de_busqueda) {
        var parametros = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpParams */]().set('buscar', _parametro_de_busqueda);
        return this.http.get(this.API_URL + 'api/modelos', { params: parametros });
    };
...
var PedidoService = (function () {
    ...
    PedidoService.prototype.buscarPedido = function (_parametro_de_busqueda) {
        var parametros = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpParams */]().set('buscar', _parametro_de_busqueda);
        return this.http.get(this.API_URL + 'api/pedidos', { params: parametros });
    };
    ...
    PedidoService.prototype.obtenerCatalogoPedidos = function () {
        return this.http.get(this.API_URL + 'api/pedidos');
    };
    ...
    PedidoService.prototype.obtenerPedidoPorId = function (_pedido_id) {
        return this.http.get(this.API_URL + 'api/pedidos/' + _pedido_id);
    };
    // Buscar producto
    ...
    PedidoService.prototype.registrarPedido = function (_pedido) {
        return this.http.post(this.API_URL + 'api/pedidos', _pedido);
    };
...
var SolicitudValidarService = (function () {
    ...
    SolicitudValidarService.prototype.validarPedido = function (_pedido) {
        return this.http
            .patch(this.API_URL + 'api/pedidos/' + _pedido._id, _pedido, {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]().set('Authorization_dagtok', 'some-token')
        });
    };
...
var UnidadService = (function () {
    ...
    UnidadService.prototype.buscarUnidad = function (_parametro_de_busqueda) {
        var parametros = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpParams */]().set('buscar', _parametro_de_busqueda);
        return this.http.get(this.API_URL + 'api/unidades', { params: parametros });
    };
...
var UsuarioService = (function () {
    ...
    UsuarioService.prototype.buscarUsuario = function (_parametro_de_busqueda) {
        var parametros = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpParams */]().set('buscar', _parametro_de_busqueda);
        return this.http.get(this.API_URL + 'api/usuarios', { params: parametros });
    };
...
var ArticuloListarTodosComponent = (function () {
    function ArticuloListarTodosComponent(articuloService, toastr, _vcr) {
    ...
    ArticuloListarTodosComponent.prototype.inputBusquedaListener = function () {
        var _this = this;
        // Dynamic typing from search box to filter on client logos
        var enCadaPalabraEscrita = __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["a" /* Observable */].fromEvent(document.getElementById('buscar-articulo'), 'keyup')
            .map(function (e) { return e.target['value']; })
            .debounceTime(400)
            .distinctUntilChanged();
        enCadaPalabraEscrita.subscribe(function (data) {
            _this.terminoDeBusqueda = data; // Actualiza termino de busqueda
            _this.buscarArticulos(_this.terminoDeBusqueda); // Busca producto
        });
    };
    ArticuloListarTodosComponent.prototype.buscarArticulos = function (_termino_de_busqueda) {
        var _this = this;
        this.articuloService.buscarArticulo(_termino_de_busqueda).subscribe(function (data) {
...
var ArticuloComponent = (function () {
    function ArticuloComponent(route, router, articuloServicio, categoriasServicio, toastr, _vcr) {
        var _this = this;
        this.route = route;
        this.router = router;
    ...
    ArticuloComponent.prototype.obtenerAccionARealizar = function () {
        ...
        if (tmp_accion === 'crear') {
            ...
            this.articuloServicio.eliminar(this.articulo_id).subscribe(function (response) {
                _this.router.navigate(['/admin/articulo/listar-todos']).then(function (result) {
                    _this.toastr.info('¡El usuario fue eliminado!.', null);
                });
            });
        }
    };
    ArticuloComponent.prototype.inicializarArticulo = function () {
        this.articulo = new __WEBPACK_IMPORTED_MODULE_2__models_index__["a" /* Articulo */](null, null, null, null, []);
    };
    ...
    ArticuloComponent.prototype.modificarArticulo = function () {
        ...
        this.articuloServicio.modificarArticulo(this.articulo)
            ...
            _this.router.navigate(['/admin/articulo/listar-todos']).then(function (result) {
                _this.toastr.info('¡El usuario fue modificado con exito!.', null);
            });
        }, function (err) {
    ...
    ArticuloComponent.prototype.crearArticulo = function () {
        ...
        this.articuloServicio.crearArticulo(this.articulo)
            ...
            _this.router.navigate(['/admin/articulo/listar-todos']).then(function (result) {
                ...
                _this.toastr.success('¡Articulo creado con exito!');
            });
        }, function (err) {
            console.log('Error occured');
        });
    ...
    ArticuloComponent.prototype.obtenerCaracteristicas = function (_categoriaElegida) {
        ...
        this.categoriasServicio.obtenerCaracteristicas(categoria_id).subscribe(function (modelo) {
            _this.articulo = new __WEBPACK_IMPORTED_MODULE_2__models_index__["a" /* Articulo */](null, null, null, modelo.categoria, modelo.propiedades);
        }).closed;
    };
    ...
    ArticuloComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__services_index__["b" /* ArticuloService */],
...
var CategoriaListarTodosComponent = (function () {
    function CategoriaListarTodosComponent(categoriaService, toastr, _vcr) {
    ...
    CategoriaListarTodosComponent.prototype.inputBusquedaListener = function () {
        var _this = this;
        // Dynamic typing from search box to filter on client logos
        var enCadaPalabraEscrita = __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["a" /* Observable */].fromEvent(document.getElementById('buscar-categoria'), 'keyup')
            .map(function (e) { return e.target['value']; })
            .debounceTime(400)
            .distinctUntilChanged();
        enCadaPalabraEscrita.subscribe(function (data) {
            _this.terminoDeBusqueda = data; // Actualiza termino de busqueda
            _this.buscarCategorias(_this.terminoDeBusqueda); // Busca producto
        });
    };
    CategoriaListarTodosComponent.prototype.buscarCategorias = function (_termino_de_busqueda) {
        var _this = this;
        this.categoriaService.buscarCategoria(_termino_de_busqueda).subscribe(function (data) {
            _this.categorias = data;
        }).closed;
    };
...
var CategoriaComponent = (function () {
    function CategoriaComponent(route, router, categoriaServicio, toastr, _vcr) {
        this.route = route;
        this.router = router;
    ...
    CategoriaComponent.prototype.obtenerAccionARealizar = function () {
        ...
        if (tmp_accion === 'crear') {
            ...
            this.categoriaServicio.eliminar(this.categoria_id).subscribe(function (response) {
                _this.router.navigate(['/admin/categoria/listar-todos']).then(function (result) {
                    _this.toastr.info('¡El usuario fue eliminado!.', null);
                });
            });
        }
    ...
    CategoriaComponent.prototype.modificarCategoria = function () {
        ...
        this.categoriaServicio.modificarCategoria(this.model)
            .subscribe(function (res) {
            _this.router.navigate(['/admin/categoria/listar-todos']).then(function (result) {
                _this.toastr.info('¡La categoria fue modificada con exito!.', null);
            });
        }, function (err) {
            console.log('Error occured');
        });
...
var PedidosComponent = (function () {
    function PedidosComponent(pedidoService, toastr, _vcr) {
    ...
    PedidosComponent.prototype.inputBusquedaListener = function () {
        var _this = this;
        // Dynamic typing from search box to filter on client logos
        var enCadaPalabraEscrita = __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["a" /* Observable */].fromEvent(document.getElementById('buscar-pedido'), 'keyup')
            .map(function (e) { return e.target['value']; })
            .debounceTime(400)
            .distinctUntilChanged();
        enCadaPalabraEscrita.subscribe(function (data) {
            _this.terminoDeBusqueda = data; // Actualiza termino de busqueda
            _this.buscaPedidos(_this.terminoDeBusqueda); // Busca producto
        });
    };
    PedidosComponent.prototype.buscaPedidos = function (_termino_de_busqueda) {
        var _this = this;
        this.pedidoService.buscarPedido(_termino_de_busqueda).subscribe(function (data) {
            _this.pedidos = data;
        }).closed;
    };
...
var UnidadListarTodosComponent = (function () {
    function UnidadListarTodosComponent(unidadService, toastr, _vcr) {
    ...
    UnidadListarTodosComponent.prototype.inputBusquedaListener = function () {
        var _this = this;
        // Dynamic typing from search box to filter on client logos
        var enCadaPalabraEscrita = __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["a" /* Observable */].fromEvent(document.getElementById('buscar-unidad'), 'keyup')
            .map(function (e) { return e.target['value']; })
            .debounceTime(400)
            .distinctUntilChanged();
        enCadaPalabraEscrita.subscribe(function (data) {
            _this.terminoDeBusqueda = data; // Actualiza termino de busqueda
            _this.buscaUnidad(_this.terminoDeBusqueda); // Busca producto
        });
    };
    UnidadListarTodosComponent.prototype.buscaUnidad = function (_termino_de_busqueda) {
        var _this = this;
        this.unidadService.buscarUnidad(_termino_de_busqueda).subscribe(function (data) {
            _this.unidades = data;
        }).closed;
    };
...
var UnidadComponent = (function () {
    function UnidadComponent(route, router, unidadService, toastr, _vcr) {
        this.route = route;
        this.router = router;
        this.unidadService = unidadService;
        this.toastr = toastr;
    ...
    UnidadComponent.prototype.obtenerAccionARealizar = function () {
        ...
        if (tmp_accion === 'crear') {
            ...
            this.unidadService.eliminar(this.unidad_id).subscribe(function (response) {
                _this.router.navigate(['/admin/unidad/listar-todos']).then(function (result) {
                    _this.toastr.info('¡La unidad fue eliminada!.', null);
                });
            });
        }
    };
    ...
    UnidadComponent.prototype.modificarUnidad = function () {
        ...
        this.unidadService.modificarUnidad(this.unidad)
            .subscribe(function (res) {
            _this.router.navigate(['/admin/unidad/listar-todos']).then(function (result) {
                _this.toastr.info('¡La Unidad fue modificada con exito!.', null);
            });
        }, function (err) {
            console.log('Error occured');
        });
    ...
    UnidadComponent.prototype.crearUnidad = function () {
        ...
        this.unidadService.crearUnidad(this.unidad).subscribe(function (res) {
            _this.router.navigate(['/admin/unidad/listar-todos']).then(function (result) {
                ...
                _this.toastr.success('¡La Unidad fue creada con exito!.', null);
            });
        }, function (err) {
            console.log(err);
        });
...
var UsuarioListarTodosComponent = (function () {
    function UsuarioListarTodosComponent(usuarioService, toastr, _vcr) {
    ...
    UsuarioListarTodosComponent.prototype.inputBusquedaListener = function () {
        var _this = this;
        // Dynamic typing from search box to filter on client logos
        var enCadaPalabraEscrita = __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["a" /* Observable */].fromEvent(document.getElementById('buscar-usuario'), 'keyup')
            .map(function (e) { return e.target['value']; })
            .debounceTime(400)
            .distinctUntilChanged();
        enCadaPalabraEscrita.subscribe(function (data) {
    ...
    UsuarioListarTodosComponent.prototype.buscaProductos = function (_termino_de_busqueda) {
        var _this = this;
        this.usuarioService.buscarUsuario(_termino_de_busqueda).subscribe(function (data) {
            _this.usuarios = data;
        }).closed;
    };
...
var UsuarioComponent = (function () {
    ...
    UsuarioComponent.prototype.obtenerAccionARealizar = function () {
        ...
        if (tmp_accion === 'crear') {
            ...
            this.usuarioService.eliminar(this.usuario_id).subscribe(function (response) {
                _this.router.navigate(['/admin/usuario/listar-todos']).then(function (result) {
                    _this.toastr.info('¡El usuario fue eliminado!.', null);
                });
            });
        }
    ...
    UsuarioComponent.prototype.crearUsuario = function () {
        ...
        this.usuarioService.crearUsuario(this.usuario).subscribe(function (res) {
            ...
            _this.router.navigate(['/admin/usuario/listar-todos']).then(function (result) {
                _this.inicializarUsuario();
                _this.toastr.error('El usuario ya existe');
            });
        });
    };
...
var environment = {
    production: false,
    api_url: '104.236.191.171',
    dev_api_url: 'localhost'
};
